...
const Authenticated = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(`http://192.168.7.15:8081/updatepassword/${employeeId}`, { employeeId, newPassword: employeePassword, confirmPassword });
            ...
            <div className='authenticatedForm'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {showPassword}
                        ...
                        <Link to='/'><button type="submit" className="m-3 button btn btn-primary">Reset</button></Link>
