            ...
            <div className='p-3 rounded w-25 border  loginForm'>
                ...
                <form action='POST' onSubmit={handleSubmit}>
                    ...
                    <div className="m-3 text-color1">
                        ...
                        <input value={employeePassword} onChange={e => setEmployeePassword(e.target.value)} type={showPassword ? 'text' : 'password'} name='password' className="form-control" id="exampleInputPassword1" />
